...
for (j in 1:22){
  ...
  tempfile = read.delim(paste("/nfs/storage/math/gross-s2/projects/mixtures/genomic_resources/gnomad/realdata_summer2019/genome/chr",j,".african_JUNE2019.INFO", sep = ''))
  tempfile$CHROM = NULL; tempfile$AC_afr = NULL; tempfile$AN_afr = NULL; tempfile$nhomalt_afr = NULL
  
  tempfile2 = read.table(paste("/nfs/storage/math/gross-s2/projects/mixtures/team_members/current_team/Greg/July11_vcf_gnomad_genomes/JUNE2019_vcf_chr",j,".recode.vcf", sep = ''), quote="\"")
...
#if (is.na(finalframe$AFR_mod2 != 0)){
...
gnomad_ref_merge_genome = finalframe
merge_info_genome = mergeinfo


#write files in txt and Rdata
write.table(gnomad_ref_merge_genome, file = '/nfs/storage/math/gross-s2/projects/mixtures/team_members/current_team/Ian/refgnomadmerge/genome/gnomad_ref_merge_genome.txt')

write.table(merge_info_genome, file = '/nfs/storage/math/gross-s2/projects/mixtures/team_members/current_team/Ian/refgnomadmerge/genome/merge_info_genome.txt')

save(gnomad_ref_merge_genome, file = '/nfs/storage/math/gross-s2/projects/mixtures/team_members/current_team/Ian/refgnomadmerge/genome/gnomad_ref_merge_genome.Rdata')

save(merge_info_genome, file = '/nfs/storage/math/gross-s2/projects/mixtures/team_members/current_team/Ian/refgnomadmerge/genome/merge_info_genome.Rdata')
